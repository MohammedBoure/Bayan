...
- [license_service.dart](file:///C:/Users/moham/Desktop/Bayan/lib/services/license_service.dart): Manages the 7-day offline trial period, machine-unique device identifier (`BYN-XXXX-XXXX-XXXX`), anti-tampering timestamp signatures, clock rollback detection, and HMAC-SHA256 activation code validation. Controls curriculum and exercise access (`canAccessCurriculum`) and notifies listeners on license state transitions.
